<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CafeWeb.WebForm1" %>
...
<body id="app-container" class="menu-default show-spinner">
    <form id="form1" runat="server">
       <nav class="navbar fixed-top">
        ...
        <a class="navbar-logo" href="Default.aspx" style="text-align: center;">
        ...
        <div class="navbar-right">
            ...
            <div class="user d-inline-block">
                <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <span>
                        <img alt="Profile Picture" src="img/profiles/accountLogo.svg" />
                    </span>
                </button>
